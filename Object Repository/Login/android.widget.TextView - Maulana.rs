...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Maulana</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Maulana' or . = 'Maulana') and @resource-id = 'com.she.sehatq:id/tvFullName']</locator>
