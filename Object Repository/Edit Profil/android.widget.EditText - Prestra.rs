...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Prestra</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Prestra' or . = 'Prestra') and @resource-id = 'com.she.sehatq:id/et_input']</locator>
