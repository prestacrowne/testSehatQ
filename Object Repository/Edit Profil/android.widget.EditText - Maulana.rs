...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Maulana</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Maulana' or . = 'Maulana') and @resource-id = 'com.she.sehatq:id/et_input']</locator>
