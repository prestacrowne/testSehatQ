...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - No. Telepon</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'No. Telepon' or . = 'No. Telepon') and @resource-id = 'com.she.sehatq:id/et_input']</locator>
