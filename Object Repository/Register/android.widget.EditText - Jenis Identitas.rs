...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Jenis Identitas</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Jenis Identitas' or . = 'Jenis Identitas') and @resource-id = 'com.she.sehatq:id/et_input']</locator>
