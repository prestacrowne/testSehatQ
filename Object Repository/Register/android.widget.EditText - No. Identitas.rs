...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - No. Identitas</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'No. Identitas' or . = 'No. Identitas') and @resource-id = 'com.she.sehatq:id/et_input']</locator>
